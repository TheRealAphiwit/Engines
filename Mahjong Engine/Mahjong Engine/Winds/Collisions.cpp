...
glm::mat3 Winds::ComputeMomentOfInertiaBox(float mass, glm::vec3 extents, glm::vec3 aPosition)
{
...
glm::mat3 Winds::ComputeMomentOfInertiaSphere(float mass, float radius)
{
